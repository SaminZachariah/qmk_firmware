...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //  Left half reads pinky→index (col5→col0), right half reads index→pinky (col0→col5)
    //  Encoder push-buttons are [4,0] (left) and [9,0] (right), between the two halves of row 3
